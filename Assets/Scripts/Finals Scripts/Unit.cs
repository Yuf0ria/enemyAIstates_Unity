// ============================================================
//  Unit.cs  –  Base class for all units
//  Simple FSM: Idle → Chase → Attack
//  No NavMesh — uses plain transform movement
// ============================================================
...
{
    // ── Stats (set in Inspector or by subclass) ───────────────────────────────
    [Header("Stats")]
    ...
    // ═════════════════════════════════════════════════════════════════════════
    //  Ability (override in subclasses)
    // ═════════════════════════════════════════════════════════════════════════
    ...
    protected virtual Color GetTeamColor() => teamID == 0 ? Color.cyan : Color.red;
